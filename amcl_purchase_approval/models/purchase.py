...
class PurchaseOrder(models.Model):
    ...
    def action_send_for_approval(self):
        for record in self:
            template_id = self.env.ref('amcl_purchase_approval.email_template_rfq_approval_request')
...
class PurchaseRejectionReason(models.TransientModel):
    ...
    def button_reject(self):
        template_id = self.env.ref('amcl_purchase_approval.email_template_rfq_rejected')
