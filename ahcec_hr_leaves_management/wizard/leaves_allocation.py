...
class leaves_allocation(models.TransientModel):
    ...
    def get_leave_type(self):
        ...
        leave_types = {
            ...
            'maternity_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_maternity'),
            'marrige_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_marriage'),
            'compassionate_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_compassionate'),
            'paternity_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_paternity'),
            'hajj_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_hajj'),
            'secondment_leave': self.env.ref('ahcec_hr_leaves_management.holiday_status_secondment'),
        }
        return leave_types
